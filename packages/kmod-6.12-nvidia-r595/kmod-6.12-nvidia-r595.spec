...
Name: %{_cross_os}kmod-6.12-nvidia-r595
Version: %{tesla_ver}
Release: 1%{?dist}
Epoch: 1
Summary: NVIDIA r595 drivers for the 6.12 kernel
...
# Graphics libs
%{_cross_libdir}/libnvidia-egl-wayland2.so.1
%{_cross_libdir}/libnvidia-egl-wayland2.so.1.0.1
