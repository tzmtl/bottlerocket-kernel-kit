...
Name: %{_cross_os}kmod-6.18-nvidia-r580-82
Version: %{tesla_ver}
Release: 1%{?dist}
Epoch: 1
...
Source10: https://developer.download.nvidia.com/compute/cuda/repos/rhel10/x86_64/nvidia-fabricmanager-%{tesla_ver}-1.x86_64.rpm
Source11: https://developer.download.nvidia.com/compute/cuda/repos/rhel10/sbsa/nvidia-fabricmanager-%{tesla_ver}-1.aarch64.rpm

# IMEX for GB200
Source20: https://developer.download.nvidia.com/compute/cuda/repos/rhel10/x86_64/nvidia-imex-%{tesla_ver}-1.x86_64.rpm
Source21: https://developer.download.nvidia.com/compute/cuda/repos/rhel10/sbsa/nvidia-imex-%{tesla_ver}-1.aarch64.rpm
...
%exclude %{_cross_libdir}/libnvidia-egl-gbm.so.1.1.2
%exclude %{_cross_libdir}/libnvidia-egl-wayland.so.1.1.20
%exclude %{_cross_libdir}/libnvidia-egl-xcb.so.1
%exclude %{_cross_libdir}/libnvidia-egl-xcb.so.1.0.3
%exclude %{_cross_libdir}/libnvidia-egl-xlib.so.1
%exclude %{_cross_libdir}/libnvidia-egl-xlib.so.1.0.3
